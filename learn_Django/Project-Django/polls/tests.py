...
class QuestionModelTests(TestCase):
    def test_was_published_recently_With_future_question(self):
        ...
        # assertIs() checks if the first argument is equal to the second argument. 
        #  they are not equal, the test will fail.
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        #assertContains() checks that the response contains a particular text.
